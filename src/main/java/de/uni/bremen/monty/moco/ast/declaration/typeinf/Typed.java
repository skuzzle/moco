...
/** Interface for AST nodes that have a type assigned to them. Typed nodes may have a set of multiple possible types and
 * a unique resolved type.
 * 
...
public interface Typed {
	...
	/** Gets the unique type of this node. Will return <code>null</code> until the type has been resolved and set via
	 * {@link #setType(Type)}
	 * 
